(()=>{
 const run=()=>{
  ...
  const photos=[
   {match:'Lungolago di Salò',src:'https://commons.wikimedia.org/wiki/Special:FilePath/Sal%C3%B2%20-%20Lungolago.jpg?width=1400',alt:'Lungolago di Salò no Lago di Garda',cap:'Lungolago di Salò'},
   {match:'Centro histórico',src:'https://commons.wikimedia.org/wiki/Special:FilePath/Sal%C3%B2%20Lago%20di%20Garda.jpg?width=1400',alt:'Centro de Salò junto ao Lago di Garda',cap:'Salò · centro histórico'},
   {match:'Última caminhada',src:'https://commons.wikimedia.org/wiki/Special:FilePath/Sal%C3%B2%20panorama.jpg?width=1400',alt:'Vista panorâmica de Salò e do Lago di Garda',cap:'Passeggiata di Salò'},
   {match:'Terminal',src:'https://commons.wikimedia.org/wiki/Special:FilePath/Venice%20Marco%20Polo%20Airport.jpg?width=1400',alt:'Aeroporto Marco Polo de Veneza',cap:'Aeroporto Marco Polo · Veneza'}
  ];
